...
print(
    "{0} files copied from /original/ directory to /images/ directory \n\n".format(
        len(files)
    )
)
##################################################################################################
...
augmentation(
    ...
    filename="fliped_" + str(i) + "_",
)
print(
    "{0} files created in /images/ directory after flipped\n\n".format(
        (aug_len + 1) * len(files) * t_flip
    )
)
####################################################################################################
...
for rot in rotates:
    ...
    i += 1
print(
    "{0} files created in /images/ directory after rotated\n\n".format(
        (aug_len + 1) * len(files) * t_flip * t_rot
    )
)
####################################################################################################
...
for aug in augmentations:
    ...
    i += 1
print(
    "{0} files created in /images/ directory after augmented\n\n".format(
        (aug_len) * len(files)
    )
)
####################################################################################################
...
print(
    "Total image data : {0} images ".format(
        int((aug_len + 1) * len(files) * t_flip * t_rot / 2)
    )
)
